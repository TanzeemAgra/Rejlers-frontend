        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-600">
                {stats?.projects.active || 0} active ΓÇó {stats?.projects.completed || 0} completed
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-600">
                ${(stats?.finance.spent || 0).toLocaleString()} spent ΓÇó {stats?.finance.pendingInvoices || 0} pending
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-600">
                {stats?.hr.activeEmployees || 0} active ΓÇó {stats?.hr.pendingTimeOff || 0} requests
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-600">
                {stats?.sales.totalLeads || 0} leads ΓÇó {stats?.sales.activeOpportunities || 0} opportunities
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-600">
                {stats?.hse.activeIncidents || 0} incidents ΓÇó {stats?.hse.assessmentsDue || 0} assessments due
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-slate-600">
                {stats?.supply.activeOrders || 0} orders ΓÇó {stats?.supply.lowStockItems || 0} low stock
              </div>
            </div>
          </div>
        </div>
